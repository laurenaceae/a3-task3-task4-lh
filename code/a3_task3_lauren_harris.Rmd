...
This document compares the body sizes of red and purple urchins collected along the coast of Santa Barbara, California from 2008 to 2020. It also compares observations of purple urchins at different sites from year to year. 
...
urchins_size_subset %>% 
  kable(digits = 2, col.names = c("Common Name", "Scientific Name","Mean Size (cm)", "Median Size (cm)", "Standard Deviation (cm)", "Sample Size")) %>% 
  kable_styling(full_width = FALSE)
```
The mean and median sizes of the red urchin are larger than the mean and median sizes of purple urchins. The spread of the data is also wider for red urchins, meaning they are more variable. This is reflected through a higher standard deviation for red urchins. The red urchins also had a larger range of values, as both urchins had values at zero but the max value  was past 12 cm for red urchins and under 10 cm for purple urchins. 
